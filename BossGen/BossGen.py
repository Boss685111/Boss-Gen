...
print(Fore.YELLOW + "Ｈｅｌｌｏ ｗｅｌｃｏｍｅ Ｔｏ ＢｏｓｓＧｅｎ Ｇｉｆｔ Ｃａｒｄ Ｇｅｎｅｒａｔｏｒ")
print(Fore.RED + ''' 
                 ▄▄▄▄▄▄▄ ▄▄▄▄▄▄▄ ▄▄▄▄▄▄▄ ▄▄▄▄▄▄▄ ▄▄  ▄▄▄▄▄▄▄ ▄▄▄▄▄▄▄ ▄▄    ▄ 
                █  ▄    █       █       █       █  ██       █       █  █  █ █
                █ █▄█   █   ▄   █  ▄▄▄▄▄█  ▄▄▄▄▄█▄▄██   ▄▄▄▄█    ▄▄▄█   █▄█ █
...
print(Fore.YELLOW + "𝕎𝕚𝕥𝕙 𝕥𝕙𝕚𝕤 𝔾𝕖𝕟𝕖𝕣𝕒𝕥𝕠𝕣 𝕪𝕠𝕦 𝕔𝕒𝕟 𝕘𝕖𝕥 𝕒 𝕓𝕦𝕝𝕜 𝕒𝕞𝕠𝕦𝕟𝕥 𝕠𝕗 𝔾𝕚𝕗𝕥 ℂ𝕒𝕣𝕕𝕤 Enjoy and take care")
print(Fore.YELLOW + "𝙟𝙤𝙞𝙣 𝙢𝙮 𝘿𝙞𝙨𝙘𝙤𝙧𝙙 𝙨𝙚𝙧𝙫𝙚𝙧 𝙛𝙤𝙧 𝙢𝙤𝙧𝙚 𝙩𝙤𝙤𝙡 𝙖𝙣𝙙 𝙨𝙩𝙪𝙛𝙛: https://discord.gg/rQyK4mrq59")
print("")
...
if(mode == "IMVU"):
    ...
    for x in range(number):
        ...
        with open(file, 'a') as out:
            out.write(generate1+generate2+generate3+generate4+generate5+generate6+generate7+generate8+generate9+generate10+newline)
print (Fore.RED + "Thanks For Using My Script")
print (Fore.RED + "Please Put Generated Gift Cards In A Checker To See If They Are Valid Cards ")
time.sleep(5)
